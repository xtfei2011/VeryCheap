...
@implementation UIViewController (TFRoute)

- (void)xtfei_toLastViewController
{
...
+ (UIViewController*)xtfei_currentViewController
{
    UIViewController* rootViewController = [UIApplication sharedApplication].delegate.window.rootViewController;
    return [self xtfei_currentViewControllerFrom:rootViewController];
}

+ (UIViewController*)xtfei_currentViewControllerFrom:(UIViewController*)viewController
{
    if ([viewController isKindOfClass:[UINavigationController class]]) {
        UINavigationController* navigationController = (UINavigationController *)viewController;
        return [self xtfei_currentViewControllerFrom:navigationController.viewControllers.lastObject];
    }
    else if([viewController isKindOfClass:[UITabBarController class]]) {
        UITabBarController* tabBarController = (UITabBarController *)viewController;
        return [self xtfei_currentViewControllerFrom:tabBarController.selectedViewController];
    }
    else if (viewController.presentedViewController != nil) {
        return [self xtfei_currentViewControllerFrom:viewController.presentedViewController];
    }
    else {
...
{
    TFCustomNavigationBar *navigationBar = [[self alloc] initWithFrame:CGRectMake(0 ,0 ,kWRScreenWidth ,[TFCustomNavigationBar navBarBottom])];
...
- (void)clickBack
{
    if (self.onClickLeftButton) {
        ...
        UIViewController *currentVC = [UIViewController xtfei_currentViewController];
        [currentVC xtfei_toLastViewController];
    }
}
...
#pragma mark - 左右按钮
- (void)xtfei_setLeftButtonWithNormal:(UIImage *)normal highlighted:(UIImage *)highlighted title:(NSString *)title titleColor:(UIColor *)titleColor
{
...
- (void)xtfei_setLeftButtonWithImage:(UIImage *)image title:(NSString *)title titleColor:(UIColor *)titleColor {
    [self xtfei_setLeftButtonWithNormal:image highlighted:image title:title titleColor:titleColor];
}

- (void)xtfei_setLeftButtonWithNormal:(UIImage *)normal highlighted:(UIImage *)highlighted
{
    [self xtfei_setLeftButtonWithNormal:normal highlighted:highlighted title:nil titleColor:nil];
}

- (void)xtfei_setLeftButtonWithImage:(UIImage *)image
{
    [self xtfei_setLeftButtonWithNormal:image highlighted:image title:nil titleColor:nil];
}

- (void)xtfei_setLeftButtonWithTitle:(NSString *)title titleColor:(UIColor *)titleColor
{
    [self xtfei_setLeftButtonWithNormal:nil highlighted:nil title:title titleColor:titleColor];
}

- (void)xtfei_setRightButtonWithNormal:(UIImage *)normal highlighted:(UIImage *)highlighted title:(NSString *)title titleColor:(UIColor *)titleColor
{
...
- (void)xtfei_setRightButtonWithImage:(UIImage *)image title:(NSString *)title titleColor:(UIColor *)titleColor
{
    [self xtfei_setRightButtonWithNormal:image highlighted:image title:title titleColor:titleColor];
}

- (void)xtfei_setRightButtonWithNormal:(UIImage *)normal highlighted:(UIImage *)highlighted
{
    [self xtfei_setRightButtonWithNormal:normal highlighted:highlighted title:nil titleColor:nil];
}

- (void)xtfei_setRightButtonWithImage:(UIImage *)image
{
    [self xtfei_setRightButtonWithNormal:image highlighted:image title:nil titleColor:nil];
}

- (void)xtfei_setRightButtonWithTitle:(NSString *)title titleColor:(UIColor *)titleColor
{
    [self xtfei_setRightButtonWithNormal:nil highlighted:nil title:title titleColor:titleColor];
}
...
+ (int)navBarBottom
{
    if ([TFCustomNavigationBar isIphoneX]) {
        return 88;
    } else {
        return 64;
    }
