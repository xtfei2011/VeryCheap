...
- (WKWebView *)webView
{
    if (!_webView) {
        ...
        _webView = [[WKWebView alloc] initWithFrame:CGRectMake(0, 0, TFMainScreen_Width, TFMainScreen_Height) configuration:configuration];
...
- (UIBarButtonItem *)backBarItem
{
    if (!_backBarItem) {
        ...
        backButton.titleLabel.font = [UIFont fontWithName:@"Helvetica-Bold" size:14];
...
- (UIProgressView *)progressView
{
    if (!_progressView) {
        ...
        _progressView.frame = CGRectMake(0, 64, self.view.xtf_width, 2);
        /*** 进度条颜色 ***/
